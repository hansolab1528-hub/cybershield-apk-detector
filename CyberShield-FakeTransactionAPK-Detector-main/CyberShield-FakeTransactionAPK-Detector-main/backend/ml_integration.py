# =====================================================================
# CyberShield ML INTEGRATION - PHASE 3
...
try:
    from ml_feature_extractor import CyberShieldFeatureExtractor
    from ml_models import CyberShieldMLClassifier
...
class HybridAPKDetector:
    ...
    def __init__(self, ml_model_path: str = "trained_models"):
        self.feature_extractor = CyberShieldFeatureExtractor()
        self.ml_classifier = CyberShieldMLClassifier(ml_model_path)
    ...
    def analyze_apk_hybrid(self, apk_path: str, existing_analysis: Dict = None) -> Dict[str, Any]:
        ...
        try:
            ...
            hybrid_results['analyzer_version'] = 'CyberShield-Hybrid-v1.0'
...
def create_training_data_from_scans(scan_results_db_path: str, output_csv_path: str) -> bool:
    ...
    try:
        ...
        feature_extractor = CyberShieldFeatureExtractor()
        training_data = []
...
if __name__ == "__main__":
    ...
    print("=== CyberShield HYBRID DETECTOR TEST ===")
